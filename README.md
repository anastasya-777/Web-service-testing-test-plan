...
#### Отчёт будет оформлен в виде файла Report.md и загружен в репозиторий проекта. Он будет содержать всю информацию о выполненных этапах, результатах тестирования, а также рекомендации по улучшению.
