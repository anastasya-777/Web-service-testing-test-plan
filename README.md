...
#### Номер карты: количество цифр 16 (2200 2222 3333 4444);
#### Фамилия и Имя владельца карты: только латинские буквы (Ivanov Ivan);
#### Срок действия карты: месяц/год (07/2026);
...
##### 2.Попытка оплаты тура с не полностью заполненным номером дебетовой карты (ввод 15 цифр): Номер карты 2200 2222 3333 444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Номер карты”.
...
##### 4.Попытка оплаты тура с невалидным сроком действия дебетовой карты ( месяц больше 12): Срок действия карты: 13/2025. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты”.
...
##### 6.Попытка оплаты тура с невалидным месяцем дебетовой карты (менее 1): Срок действия карты: 00/2025. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты””.

##### 7.Попытка оплаты тура с невалидным годом дебетовой карты (менее текущего года): Срок действия карты: 07/2023. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Срок действия карты истек”.

##### 8.Попытка оплаты тура с заполненным только номером дебетовой карты: Номер карты 1111 2222 3333 4444. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.

##### 9.Попытка оплаты тура с заполненным только именем владельца дебетовой карты: Имя владельца - Иванов Иван. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.

##### 10.Попытка оплаты тура с заполненным только сроком действия дебетовой карты: Срок действия карты - 07/2025. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.
...
##### 12.Попытка оплаты тура с невалидным годом дебетовой карты (более 5 лет вперед от текущей даты): Срок действия карты: 10/2045. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты””.

##### 13.Попытка оплаты тура с невалидным форматом номера дебетовой карты: Номер карты: 2200 2222 3333 4444 5 (более 16 цифр). Остальные поля валидные. Нажать кнопку “продолжить”.Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Номер карты”.
...
##### 15.Попытка оплаты тура с невалидным форматом срока действия дебетовой карты: Срок действия карты: 07/20 (недостаточно цифр в году). Остальные поля валидные. Нажать кнопку “продолжить”.Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты”.
...
##### 2.Попытка оплаты тура с не полностью заполненным номером кредитной картой (ввод 15 цифр): Номер карты 2200 2222 3333 444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Номер карты”.
...
##### 4.Попытка оплаты тура с невалидным сроком действия кредитной картой ( месяц больше 12): Срок действия карты: 13/2025. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты”.
...
##### 6.Попытка оплаты тура с невалидным месяцем кредитной карты (менее 1): Срок действия карты: 00/2025. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты””.

##### 7.Попытка оплаты тура с невалидным годом кредитной карты (менее текущего года): Срок действия карты: 07/2023. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Срок действия карты истек”.

##### 8.Попытка оплаты тура с заполненным только номером кредитной карты: Номер карты 1111 2222 3333 4444. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.

##### 9.Попытка оплаты тура с заполненным только именем владельца кредитной карты: Имя владельца - Иванов Иван. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.

##### 10.Попытка оплаты тура с заполненным только сроком действия кредитной карты: Срок действия карты - 07/2025. Остальные поля пустые. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Не заполнены обязательные поля карты”.
...
##### 12.Попытка оплаты тура с невалидным годом кредитной карты (более 5 лет вперед от текущей даты): Срок действия карты: 10/2045. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты”.

##### 13.Попытка оплаты тура с невалидным форматом номера кредитной карты: Номер карты: 2200 2222 3333 4444 5 (более 16 цифр). Остальные поля валидные. Нажать кнопку “продолжить”.Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Номер карты”.
...
##### 15.Попытка оплаты тура с невалидным форматом срока действия  кредитной карты: Срок действия карты: 07/20 (недостаточно цифр в году). Остальные поля валидные. Нажать кнопку “продолжить”.Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Неверно заполнено поле “Срок действия карты”.
...
##### 1.Попытка оплаты тура с недостаточным балансом на дебетовой карте: Номер карты 2200 2222 3333 4444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Недостаточный баланс на карте”.

##### 2.Попытка оплаты тура с ограничениями на проведение операций на дебетовой карте: Номер карты 2200 2222 3333 4444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Ограничения на проведение операций”.

##### 3.Попытка оплаты тура с заблокированной дебетовой карты: Номер карты: 2200 2222 3333 4444 (заблокирована). Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Карта заблокирована”.


### Негативные сценарии (оплата тура кредитной картой):

##### 1.Попытка оплаты тура с недостаточным балансом на кредитной картой: Номер карты 2200 2222 3333 4444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Недостаточный баланс на карте”.

##### 2.Попытка оплаты тура с недостаточным лимитом на кредитной карте: Номер карты 2200 2222 3333 4444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Недостаточный лимит на карте”.

##### 3.Попытка оплаты тура с ограничениями на проведение операций на кредитной карте: Номер карты 2200 2222 3333 4444. Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Ограничения на проведение операций”.

##### 4. Попытка оплаты тура с заблокированной кредитной карты: Номер карты: 2200 2222 3333 4444 (заблокирована). Остальные данные валидные. Нажать кнопку “продолжить”. Ожидаемый результат: Появление всплывающего окна с сообщением “Ошибка! Карта заблокирована”.
...
#### Отчёт будет оформлен в виде файла Report.md и загружен в репозиторий проекта в папку Documents. Папка Documents будет содержать всю информацию о выполненных этапах, результатах тестирования, а также рекомендации по улучшению.
